...
namespace WebApplication.Controllers
{
    public class SalesReasonsController : Controller
    {
        ...
        {
            return View(manager.ReadSalesReason());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            //    return HttpNotFound();
            //}
            var salesReason = manager.ReadSalesReason(new SalesReason() { SalesReasonID = Int32.Parse(id.ToString()) });
        ...
        public ActionResult Create(SalesReason salesReason)
        {
            if (ModelState.IsValid)
            {
                ...
                //db.SaveChanges();
                manager.CreateNewSalesReason(salesReason);
        ...
        public ActionResult Edit(SalesReason salesReason)
        {
            if (ModelState.IsValid)
            {
                ...
                //db.SaveChanges();
                manager.UpdateSalesReason(salesReason);
                return RedirectToAction("Index");
            }
            return View(salesReason);
        }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //db.SaveChanges();
            manager.DeleteSalesReason(salesReason);
            return RedirectToAction("Index");
        }
